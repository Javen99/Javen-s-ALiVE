...
switch (_taskState) do {
    case "init": {
        ...
        private _leader = createAgent [selectRandom ["C_man_p_fugitive_F", "C_man_polo_4_F", "C_man_polo_5_F", "C_man_w_worker_F"], _leaderPosition, [], 0, "NONE"];
    ...
    case "Meet": {
        ...
        private _leader = [_targets, 0, objNull, [objNull]] call BIS_fnc_param;
